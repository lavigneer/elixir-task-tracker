defmodule TaskTracker.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      TaskTracker.Repo,
      {Ecto.Migrator,
       repos: Application.fetch_env!(:task_tracker, :ecto_repos), skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:task_tracker, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: TaskTracker.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: TaskTracker.Finch},
